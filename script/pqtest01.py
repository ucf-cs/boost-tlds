...
def main():
    ...
    for pq_type in [0, 6, 7]:
        ...
        for thread in [1, 2, 4]:
            wall_time_perthread = []
            for txn_size in [1, 2, 4]:
                wall_time_pertranssize = []
                cpu_time = 0.0
                wall_time = 0.0
                commit = 0
                abort = 0
                ...
                for i in xrange(0, average):
                    # print(pq_type, thread, iteration, txn_size, key_range, insertion, deletion)
                ...
                wall_time_pertranssize.append(str(wall_time))
                wall_time_pertranssize.append(str(commit))
                wall_time_pertranssize.append(str(fake_abort))
                wall_time_perthread.append(wall_time_pertranssize)
